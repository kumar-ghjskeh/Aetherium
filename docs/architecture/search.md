...
chunk `search_text`, collection metadata, tag names, conversation titles, and habit metadata.
SQLite-backed tests use a deterministic case-insensitive fallback.
