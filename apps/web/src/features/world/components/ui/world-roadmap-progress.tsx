...
const WORLD_ROADMAP_PHASES: WorldRoadmapPhase[] = [
  ...
  { id: "W12", label: "Coding Arena", status: "next" },
  { id: "W13", label: "Project Dock", status: "remaining" },
  { id: "W14", label: "Progress Tower", status: "remaining" },
  { id: "W15", label: "Achievement Hall", status: "remaining" },
  { id: "W16", label: "Personal Sanctuary", status: "remaining" },
  { id: "W17", label: "Navigation", status: "remaining" },
  { id: "W18", label: "Atmosphere", status: "remaining" },
  { id: "W19", label: "Audio", status: "remaining" },
